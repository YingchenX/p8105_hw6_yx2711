...
Also, New York, NY has the narrowest confidence interval for the odds ratio and Albuquerque, NM has the widest confidence interval for the odds ratio. The variation in the estimated ORs for Albuquerque, NM is the highest and for New York, NY is the lowest.
...
Fit a model with birthweight as the outcome and mother's age at delivery and mother's race as the predictors. 
```{r}
...
*   using head circumference, length, sex and all interactions as predictors
```{r}
